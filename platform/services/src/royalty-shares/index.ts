/**
 * RoyaltyShares Services - Application Layer Export
 *
...
/**
 * RoyaltyShares Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for royalty-shares domain.
 */
