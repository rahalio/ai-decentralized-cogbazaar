 ...
 *
 * @returns The core table name (e.g., "cogbazaar-core-dev")
 ...
 *
 * @returns The base table name (e.g., "cogbazaar-base-dev")
 ...
 *
 * @returns The analytics table name (e.g., "cogbazaar-analytics-dev")
 ...
 *
 * @returns The realtime table name (e.g., "cogbazaar-app-realtime-dev")
