/**
 * GrantPools Services - Application Layer Export
 *
...
/**
 * GrantPools Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for grant-pools domain.
 */
